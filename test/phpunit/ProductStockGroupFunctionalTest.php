...
/**
 * \file    test/phpunit/ProductStockGroupFunctionalTest.php
...
/**
 * Class ProductStockGroupFunctionalTest
 *
 ...
 *
 * @package Testproductstockgroup
 */
class ProductStockGroupFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modProductStockGroup')->click();
		} else {
			// Disable the module
			$this->byHref('modProductStockGroup')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/productstockgroup/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('productstockgroup/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/productstockgroup/admin/about.php');
		$this->authenticate();
		return $this->assertContains('productstockgroup/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('productstockgroupwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modProductStockGroup_ProductStockGroupTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProductStockGroup_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
